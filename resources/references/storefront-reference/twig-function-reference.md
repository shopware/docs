...
| `sw_sanitize` | Filters tags and attributes from a given string. By default twig's autoescaping is on so this filter is to explicitly allow basic html tags like <i>,<b>,... | --- |
