...
You can find the original version [here](https://github.com/shopware/platform/blob/trunk/adr/api/2020-07-02-implement-sales-channel-context-token-requirement)
:::
