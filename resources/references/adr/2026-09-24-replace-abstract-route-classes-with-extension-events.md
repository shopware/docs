...
# Replace abstract route classes with the extension event system

::: info
This document represents an architecture decision record (ADR) and has been mirrored from the ADR section in our Shopware 6 repository.
You can find the original version [here](https://github.com/shopware/shopware/blob/trunk/adr/2026-09-24-replace-abstract-route-classes-with-extension-events.md)
:::
...
Shopware already provides `Extension` and `ExtensionDispatcher` for this purpose, as defined in [Transition to an Event-Based Extension System](./2024-06-18-extended-event-system).
...
* Update the developer guides for [adding Store API routes](/docs/guides/plugins/plugins/framework/store-api/add-store-api-route.html) and [overriding existing routes](/docs/guides/plugins/plugins/framework/store-api/override-existing-route.html), which currently teach the decorator pattern.
