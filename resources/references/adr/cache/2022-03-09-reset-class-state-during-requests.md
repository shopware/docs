...
You can find the original version [here](https://github.com/shopware/platform/blob/trunk/resources/references/adr/cache/2022-03-09-reset-class-state-during-requests.md)
{% endhint %}
