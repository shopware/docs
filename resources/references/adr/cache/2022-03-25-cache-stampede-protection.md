...
You can find the original version [here](https://github.com/shopware/platform/blob/trunk/resources/references/adr/cache/2022-03-25-cache-stampede-protection.md)
{% endhint %}
