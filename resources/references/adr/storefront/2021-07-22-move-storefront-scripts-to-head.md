...
You can find the original version [here](https://github.com/shopware/platform/blob/trunk/resources/references/adr/storefront/2021-07-22-move-storefront-scripts-to-head.md)
{% endhint %}
