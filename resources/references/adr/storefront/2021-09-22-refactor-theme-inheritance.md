...
You can find the original version [here](https://github.com/shopware/platform/blob/trunk/resources/references/adr/storefront/2021-09-22-refactor-theme-inheritance.md)
{% endhint %}
