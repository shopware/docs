...
You can find the original version [here](https://github.com/shopware/platform/blob/trunk/resources/references/adr/extension/2020-09-08-custom-field-label-loading-in-storefront.md)
{% endhint %}
