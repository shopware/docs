...
You can find the original version [here](https://github.com/shopware/platform/blob/trunk/resources/references/adr/performance/2022-03-25-prevent-mail-updates.md)
{% endhint %}
