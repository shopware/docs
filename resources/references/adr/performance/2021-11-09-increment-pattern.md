...
You can find the original version [here](https://github.com/shopware/platform/blob/trunk/resources/references/adr/performance/2021-11-09-increment-pattern.md)
{% endhint %}
