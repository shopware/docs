...
| **Available Services** | [repository](./data-loading-script-services-reference#RepositoryFacade)<br>[config](./miscellaneous-script-services-reference#servicesconfig-shopwarecoresystemsystemconfigfacadesystemconfigfacade-systemconfigfacade)<br>[store](./data-loading-script-services-reference#servicesstore-shopwarecoreframeworkdataabstractionlayerfacadesaleschannelrepositoryfacade-saleschannelrepositoryfacade)<br> |
| **Stoppable**          | `false`                  |
