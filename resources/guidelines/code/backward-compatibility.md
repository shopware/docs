...
| Changing the parameters of a vue event                       | ⚪ PARTIAL | Only with new optional parameters which have a default value. Only when the method receives an object as parameter and when working with destructuring                                                             |
