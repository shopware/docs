...
| Use Case                                                  | Allowed?   | Notes / Alternatives                                                                                                                                                                                                                       |
| ---                                                       | ---        | ---                                                                                                                                                                                                                                        |
| Renaming or removing CSS definitions.                     | ⚪ PARTIAL | Only CSS properties which have a visual effect, but no structure or functional CSS properties. Not allowed are: <ul><li>display position</li><li>visibility</li><li>z-index</li><li>pointer-events</li><li>overflow</li><li>transform</li> |
...
| Use Case                                                    | Allowed?   | Notes / Alternatives                                                                                                                                                                                                                                        |
| ---                                                         | ---        | ---                                                                                                                                                                                                                                                         |
| Renaming or removing CSS definitions.                       | ⚪ PARTIAL | Only CSS properties which have a visual effect, but no structure or functional CSS properties. Not allowed are: <br><ul><li>display</li><li>position</li><li>visibility</li><li>z-index</li><li>pointer-events</li><li>overflow</li><li>transform</li></ul> |
