...
- We declare **DTO classes** as `final` to indicate that we do not intend thrid party developers to derive from these classes. To append more data to DTOs we use the base `Struct` class which allows **Extensions**.
