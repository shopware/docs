...
You can find the original version [here](https://github.com/shopware/shopware/blob/trunk/coding-guidelines/core/ci-workflows.md)
:::

# CI workflows

The rules for `.github/` are in [`.github/AGENTS.md`](../../.github/AGENTS).
...
- Tests must not terminate the process: [`unit-tests.md`](unit-tests) and the
  `shopware-phpunit-tests` skill.
- Agent skills and their unattended CI twins: [`agent-skills.md`](agent-skills).
- gh aw setup, pinning, and secrets: [`.github/aw/README.md`](../../.github/aw/).
