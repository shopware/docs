---
nav:
  title: 6.5 new php language features
  position: 10
...
You can find the original version [here](https://github.com/shopware/platform/blob/trunk/code/core/6.5-new-php-language-features.md)
:::
...
See the [Use PHP 8.1 Enums](../../adr/feature-adoption/2023-02-06-php-enums) ADR for the decision and migration strategy.
...
See the [Symfony Dependency Management](../../adr/feature-adoption/2023-02-06-symfony-dependency-management) ADR for the decision and migration strategy.
