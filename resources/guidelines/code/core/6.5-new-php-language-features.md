...
See the [Symfony Dependency Management](https://developer.shopware.com/docs/resources/references/adr/2023-05-16-symfony-dependency-management.html) ADR for the decision and migration strategy.
