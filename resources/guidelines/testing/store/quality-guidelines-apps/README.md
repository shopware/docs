...
* Add the company logo and the manifest file. For more support, refer to our App Base Guide.
...
* The iFrame can be accessed by URL or the barcode generated by [PHP index](https://gist.github.com/samt/1175098).

* The app UI can be provided through the iFrame mentioned above.

{% hint style="warning" %}
SSA needs a minimum function, for instance, a landing page where customers can add their names and addresses.
{% endhint %}
