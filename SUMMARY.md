...
* [Extensions](guides/plugins/README.md)
  ...
  * [Plugins](guides/plugins/plugins/README.md)
    ...
    * [Content](guides/plugins/plugins/content/README.md)
      ...
      * [CMS](guides/plugins/plugins/content/cms-1/README.md)
        * [Add CMS element](guides/plugins/plugins/content/cms-1/add-cms-element.md)
  ...
  * [Themes](guides/plugins/plugins-1/README.md)
    * [Theme base guide](guides/plugins/plugins-1/theme-base-guide.md)
    * [Create a first theme](guides/plugins/plugins-1/create-a-theme.md)
    * [Differences Plugins and Apps vs Themes](guides/plugins/plugins-1/differences-plugins-and-apps-vs-themes.md)
    * [Theme configuration](guides/plugins/plugins-1/theme-configuration.md)
    * [Add SCSS Styling and JavaScript to a Theme](guides/plugins/plugins-1/add-css-js-to-theme.md)
    * [Override Bootstrap variables in a Theme](guides/plugins/plugins-1/override-bootstrap-variables-in-a-theme.md)
    * [Add assets to a Theme](guides/plugins/plugins-1/add-assets-to-theme.md)
    * [Theme inheritance](guides/plugins/plugins-1/add-theme-inheritance.md)
    * [Theme with Bootstrap styling](guides/plugins/plugins-1/add-theme-inheritance-without-resources.md)
...
* [References](resources/references/README.md)
  * [API Reference](resources/references/api-reference/README.md)
    * [Store API Reference](resources/references/api-reference/store-api-reference.md)
  ...
  * [Tests Reference](resources/references/tests-reference.md)
