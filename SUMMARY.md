...
* [Extensions](products/extensions/README.md)
  ...
  * [Advanced Search](products/extensions/advanced-search/README.md)
    * [Installation](products/extensions/advanced-search/installation.md)
    * [Define a custom Elasticsearch Definition](products/extensions/advanced-search/How-to-define-your-custom-Elasticsearch-definition.md)
    * [Add more fields to product search](products/extensions/advanced-search/How-to-add-more-fields-to-product-search.md)
    * [Configure Searchable Fields](products/extensions/advanced-search/How-to-configure-searchable-fields.md)
    * [Language analyzers](products/extensions/advanced-search/How-to-add-modify-language-analyzers-stopwords-stemmer.md)
    * [Cross search](products/extensions/advanced-search/Cross-search.md)
    * [Extending search template](products/extensions/advanced-search/How-to-extend-the-search-and-suggest-template.md)
    * [Modify search logic](products/extensions/advanced-search/How-to-modify-search-logic.md)
    * [Search and suggest routes](products/extensions/advanced-search/Search-and-suggest-routes.md)
    * [Completion](products/extensions/advanced-search/How-to-modify-completion.md)
...
* [Hosting](guides/hosting/README.md)
  ...
  * [Infrastructure](guides/hosting/infrastructure/README.md)
    ...
    * [Scheduled Task](guides/hosting/infrastructure/scheduled-task.md)
