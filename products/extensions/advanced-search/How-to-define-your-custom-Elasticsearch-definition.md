...
Each index will contain multiple language-based fields; refer to the [ADR](../../../resources/references/adr/2023-04-11-new-language-inheritance-mechanism-for-opensearch.md) and adjust your custom Elasticsearch definition's configuration mapping to adapt to the new mapping structure.
