...
When Shopware installs or updates an [app](../../../plugins/apps/), it must register with the Shopware registration server. This registration handshake proves that you own the license domain and are authorized to use the app. The handshake requires:
...
Without a license domain, app installation fails. If you only use [plugins](../../../plugins/), you don't need a license domain, but you cannot install any official Shopware apps.
