...
The [Shopware 6 production template](https://github.com/shopware/production) enables you to build, package and deploy Shopware 6 to production shops. This template is also used
...
The template is optimized for production usage and contains basic development tooling. 
