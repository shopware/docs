...
::: info
When running against a production environment, make sure you have informed your hosting provider as maybe your IP will be blocked for a short time or limited to a certain amount of requests, which could lead to a false positive. Generally Grafana Clou is recommended as it allows to distribute the load across multiple locations.
:::
