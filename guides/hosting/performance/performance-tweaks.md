...
Refer to this article to know more on [when to use plain SQL and DAL](https://developer.shopware.com/docs/v/6.4/resources/references/adr/dal/2021-05-14-when-to-use-plain-sql-or-dal).
