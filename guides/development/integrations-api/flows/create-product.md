...
The following example shows how to find the product you created in a storefront-style listing:
...
Useful search-criteria options:
...
- `term` performs a weighted text search
...
If the cart is empty, Shopware returns the message: `Cart is empty.`
