...
There is an option to upload a video demonstrating the extension's functionality. This facilitates the review process and can also be used in-store to present the features to customers. The video should be in English or German and recorded in our test environment.

## How will the code quality be verified?

After the functional test, the code quality is reviewed. Our developers will check whether it has been developed in accordance with Shopware standards.
...
## Do you need to declare third-party APIs and services?

Extensions that call external APIs or other services (sending or receiving data) must declare those integrations—for example, payment or logistics providers such as PayPal or DHL, or your own backend.
