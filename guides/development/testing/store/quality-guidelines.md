...
These guidelines apply to all extensions distributed via the Shopware Store (plugins and apps). This page is the **overview**. Detailed rules live in the topic pages below—use them when you implement and test your extension.
...
## Topic guides (detailed requirements)

| Topic | Guide |
|------|--------|
| Listings, translations, previews, manufacturer profile | [Content and translations](./content-and-translations.md) |
| Storefront UX, performance, Lighthouse, console errors | [Storefront, performance, and errors](./storefront-performance-and-errors.md) |
| Sitemaps, robots, structured data, rich results | [SEO and structured data](./seo-and-structured-data.md) |
| Cookie Consent Manager and DSGVO subprocessors | [Cookies and privacy](./cookies-and-privacy.md) |
| Install/uninstall, Extension Manager, data cleanup | [Uninstallation and data cleanup](./installation-and-cleanup.md) |
| Code review, logging, JavaScript, plugin packaging | [Code quality](./code-quality.md) |
| APIs, apps vs. plugins, message queue, STP / commercial | [Functionality and integration](./functionality-integration.md) |
| Typical ZIP/composer/review mistakes | [Common Store review errors](./store-review-errors.md) |
...
::: info
[Test your app for the Shopware Store (DE)](https://www.youtube.com/watch?v=gLb5CmOdi4g); an English version is planned.
:::
