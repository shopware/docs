...
Shopware comes with a default theme built on top of Bootstrap 5. Everything you can do with Bootstrap, you can do with the Shopware Storefront. For background on the Storefront frontend stack and Bootstrap foundation, see the [Storefront](../../../concepts/framework/architecture/storefront-concept.md) concept.
