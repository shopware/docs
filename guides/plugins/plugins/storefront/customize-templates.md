...
{% hint style="info" %}
Also remember to not only activate your plugin but also to assign your theme tu the correctt sales channel by clicking on it in the sidebar, going to the tab Theme and selecting your theme.
{% endhint %}
