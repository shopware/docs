...
* Knowing how to [listen to events by using a subscriber](../../framework/event/listening-to-events.md)
* Knowing how to [customize storefront templates](../templates/customize-templates.md)
...
Refer to the respective section of this guide for detailed information on how to [extend templates and override blocks](../templates/customize-templates.md).
