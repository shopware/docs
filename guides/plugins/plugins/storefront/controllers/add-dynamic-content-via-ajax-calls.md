...
Again this is built upon the [adding custom JavaScript](../javascript/add-custom-javascript.md) article, so if you don't already know what Storefront `plugins` are, hold on and read it first.
...
Even if you use it to fetch data from the database, but in that case, you probably want to learn more about the [DAL](../../../../../concepts/framework/data-abstraction-layer.md).
