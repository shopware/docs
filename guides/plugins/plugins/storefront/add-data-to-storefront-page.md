...
So you should know and understand the first few lines if you've read our guide about [reading data](../framework/data-handling/reading-data) first.
...
You can find detailed information on how to extend templates and override blocks [here](customize-templates).
