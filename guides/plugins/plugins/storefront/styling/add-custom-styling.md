...
::: info
Refer to the theme guide **[Override Bootstrap Variables in a Theme](../../../themes/styling/override-bootstrap-variables-in-a-theme.md)** if you want to override some of the default Shopware variables.
:::
