...
A running plugin is required. Read the [Plugin Base Guide](../../plugin-base-guide.md) for guidance on creating one.

Reviewing the [Database migrations](../../database/database-migrations.md) guide is also advisable.
