...
This guide requires you to already have a basic plugin running. Head over to the [Plugin base guide](../../plugin-base-guide.md) to learn how to create a plugin.

Reading the guide on [adding custom JavaScript plugins](../javascript/add-custom-javascript.md) beforehand might also be helpful.
...
As explained in the guide on [adding custom JavaScript](../javascript/add-custom-javascript.md) we load our JavaScript plugin by creating `index.html.twig` template in the `<plugin root>/src/Resources/views/storefront/page/content/` folder.
