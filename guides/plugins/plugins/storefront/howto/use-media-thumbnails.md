...
You will need a plugin as a base. Refer to the [plugin base guide](../../plugin-base-guide.md) to learn how to create one.
...
* [Adding custom assets](../styling/add-custom-assets.md)
