...
As most guides, this one is built upon our \[PLACEHOLDER-LINK: Plugin base guide\], but that one is not necessary, you do need a running plugin though! Also this guide will **not** explain how to create a JavaScript plugin in general, head over to our guide \[PLACEHOLDER-LINK: Add custom javascript\] to understand how that's done in the first place.
...
Everytime you don't find an event to implement the changes you need, you may have to override the plugin itself. For this case, head over to our guide about \[PLACEHOLDER-LINK: Override existing javascript\].
