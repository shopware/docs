...
Shopware separates responsibilities between domains (Core, Storefront, Administration). Plugins must respect these boundaries to ensure deterministic behavior, testability, and compatibility.
