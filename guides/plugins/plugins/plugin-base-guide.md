...
This guide will teach you the basics of creating your very first plugin from scratch, which then can be installed to your Shopware 6 instance. Refer to the guide section to know how to [Install Shopware 6](../../installation/overview).
