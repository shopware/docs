...
This plugin is built upon our plugin from the [PLACEHOLDER-LINK: Plugin base guide], but the examples mentioned here are applicable
...
Furthermore, you definitely need to know how to create a custom component in the administration, which is covered here [PLACEHOLDER-LINK: Creating a component].
...
about [PLACEHOLDER-LINK: Creating a component] first.
...
Head over to our guide, which will explain exactly that: [PLACEHOLDER-LINK: Creating a custom CMS element]
