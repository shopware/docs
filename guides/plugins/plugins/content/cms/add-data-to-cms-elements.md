...
With `autoconfigure` enabled, the class is automatically registered because it extends `AbstractCmsElementResolver` — no additional configuration or attributes are needed.
