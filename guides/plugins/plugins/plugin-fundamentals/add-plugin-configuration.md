# Adding your plugin configuration

In our guide on how to [create a plugin configuration page](TBA), you can learn how to provide this possibility to use 
configuration possibilities in your plugins. This guide will aid you on how to use this configuration in your plugin.
