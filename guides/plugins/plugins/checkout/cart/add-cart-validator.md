...
For this guide, you'll need a working plugin, which you learn to create [here](../../plugin-base-guide). Also, you'll have to know the [Dependency Injection container](../../plugin-fundamentals/dependency-injection), since that's going to be used in order to register your custom validator.
