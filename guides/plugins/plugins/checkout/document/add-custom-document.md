...
Defining custom templates for custom documents is possible by adding a new document **type**, as explained in [the Add Custom Document Type guide](add-custom-document-type).
