...
This guide is built upon the [Plugin Base Guide](../../plugin-base-guide.md), and the entity extension described in [Adding Complex data to existing entities](../../framework/data-handling/add-complex-data-to-existing-entities#adding-a-field-without-database).
