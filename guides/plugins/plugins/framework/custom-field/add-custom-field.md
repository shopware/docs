...
Shopware's custom field system allows you to extend entities, without writing a complete entity extension. This is possible by storing the additional data in a [JSON-Field](https://dev.mysql.com/doc/refman/8.0/en/json.html). Custom fields therefore can only be used to store scalar values. If you'd like to create associations between entities, you'll need to use an \[PLACEHOLDER-LINK: Entity extension\].
...
This guide is built upon both the \[PLACEHOLDER-LINK: Plugin base guide\] as well as the \[PLACEHOLDER-LINK: Add custom complex data\] guide. The latter explained how to create your very first entity, which is used in the following examples.
...
Also, adding translatable custom fields is covered here in short as well, for which you'll need to understand how translatable entities work in general. This is covered in our guide about \[PLACEHOLDER-LINK: Adding data translations\]. This subject will **not** be covered in depth in this guide.

## Supporting custom fields with your entity

This short section will cover how to add a custom field support for your custom entity. As previously mentioned, the example from our \[PLACEHOLDER-LINK: Add custom complex data\] guide is used and extended here.
...
Once again, this example is built upon the \[PLACEHOLDER-LINK: Add custom complex data\] guide, which also comes with an example migration. This one will be used in this example here as well.
...
For that case, you can simply use your entities' repository and start creating or updating entities with custom fields. If you don't understand what's going on here, head over to our guide about \[PLACEHOLDER-LINK: Writing data\] first.
...
While theoretically your custom field is now properly defined for the administration, you'll still have to do some work in your custom entities' administration module. This will be covered in the guide about \[PLACEHOLDER-LINK: Using custom fields in your module\].

## Next steps

If you want to extend an entity with new associations and non-scalar values, head over to our guide regarding \[PLACEHOLDER-LINK: Extending existing entities\]. In case you missed it, here is the guide which explains how to \[PLACEHOLDER-LINK: Using custom fields in your module\].
