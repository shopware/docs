...
Usually you want to render your custom component here, which is explained [here](../module-component-management/add-custom-component.md). If you write experimental [Single File Components](../single-file-components/tutorial/build-your-own-component.md), `component` can also be an imported `.vue` component instead of a registered component name. But that is not all! Routes can have parameters, to then be handed to the components being rendered and much more. Learn more about what the Vue Router can do in its official [Documentation](https://router.vuejs.org/guide/essentials/dynamic-matching.html#reacting-to-params-changes).
