...
[adding a menu entry](./add-menu-entry.md)

The second one refers to setting up custom routes, its guide can be found in the guide on [adding custom routes](./add-custom-route.md).
