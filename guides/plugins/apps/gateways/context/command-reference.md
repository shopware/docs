...
| `firstName`              | string | x                         | The first name of the customer                                                                                                |
| `lastName`               | string | x                         | The last name of the customer                                                                                                 |
| `email`                  | string | x                         | The email address of the customer                                                                                             |
...
| `storefrontUrl`          | string | x                         | The storefront URL of the sales channel (You find available domains in the sales channel context -> sales channel -> domains) |
...
| `billingAddress`         | object | x                         | The billing address of the customer, s. `AddressResponseStruct` for available fields                                          |
...
| `firstName`              | string | x        | The first name of the address owner                   |
| `lastName`               | string | x        | The last name of the address owner                    |
| `salutationId`           | string |          | The ID of the salutation to use for the address owner |
| `street`                 | string | x        | The street of the address                             |
| `zipcode`                | string | x        | The ZIP code of the address                           |
| `city`                   | string | x        | The city of the address                               |
...
| `countryId`              | string | x        | The ID of the country for the address                 |
