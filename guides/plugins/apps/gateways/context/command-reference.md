...
These properties can be set in the custom `data` object of the `context_register-customer` command.
...
| `password` | string | (for non-guest customers) | The password for the customer (plain text, will be hashed by the shop before being stored)                                              |
