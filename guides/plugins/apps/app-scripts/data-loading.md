...
The criteria object that is used inside the app scripts behaves and looks the same as the [JSON criteria used for the API](../../../development/integrations-api/search-criteria.md).
