...
This guide will cover customizing Storefront templates with an app.

## Prerequisites

As most guides, this guide is built upon the [App base guide](../app-base-guide), so you might want to have a look at it. Other than that, knowing [Twig](https://twig.symfony.com/) is a big advantage for this guide, but that's not necessary.
