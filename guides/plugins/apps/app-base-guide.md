...
* `shopSecret`: The secret for the shop generated by the app used for signing requests
...
You can find out more about how to use these api-credentials in our Admin API authentication guide.
