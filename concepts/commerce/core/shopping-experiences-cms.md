...
<PageRef page="../../../guides/plugins/plugins/content/cms/add-cms-block" title="Add CMS Block (Plugin)" sub="Learn how to add a CMS block using the plugin system" />

<PageRef page="../../../guides/plugins/apps/content/cms/add-custom-cms-blocks" title="Add CMS Block (App)" sub="Learn how to add a CMS block using the app system" />

<PageRef page="../../../guides/plugins/plugins/content/cms/add-cms-element" title="Add CMS element" sub="Learn how to add a CMS element using the plugin system" />
