...
1. Fully cloud compatible: By decoupling Shopware and your app, your app is automatically compatible for the use in a multi tenant cloud system, therefore your app can be used within self-managed shops and shops on [Shopware cloud](../../products/cloud.md).
