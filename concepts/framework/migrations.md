...
{% content-ref url="../../guides/plugins/plugins/plugin-fundamentals/database-migrations.md" %}
[database-migrations.md](../../guides/plugins/plugins/plugin-fundamentals/database-migrations.md)
{% endcontent-ref %}
